...
var listTypes = [{ label: 'UL', style: 'unordered-list-item', icon: 'icon-unordered-list-item' }, { label: 'OL', style: 'ordered-list-item', icon: 'icon-ordered-list-item' }];
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          listTypes.map(function (item) {
            return _react2.default.createElement(
              'div',
              { className: (0, _classnames2.default)('btn common-btn', { active: blockType === item.style }), key: item.style },
