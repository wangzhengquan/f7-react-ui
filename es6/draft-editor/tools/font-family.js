...
exports.fontFamilyStyleMap = undefined;
...
var fontFamilyStyleMap = function () {
  return fontFamilyList.reduce(function (res, item) {
            ...
            _react2.default.createElement(
              ...
              fontFamilyList.map(function (item) {
                return _react2.default.createElement(
                  ...
                  _react2.default.createElement('input', { type: 'radio', name: 'font-name-radio', value: item.value, checked: _this2.props.edit.state.editorState.getCurrentInlineStyle().has(prefix + item.name), onChange: _this2.handleChangeFontFamily.bind(_this2, item.name) }),
                  _react2.default.createElement(
                    'div',
...
exports.fontFamilyStyleMap = fontFamilyStyleMap;
