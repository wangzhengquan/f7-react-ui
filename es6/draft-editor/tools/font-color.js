...
exports.fontColorStyleMap = undefined;
...
var fontColorStyleMap = function () {
  var styleMap = {};
  fontColorList.forEach(function (list) {
    list.forEach(function (color) {
      styleMap[prefix + color] = { color: color };
    });
  });
  return styleMap;
}();
...
var FontColor = function (_React$Component) {
  ...
  _createClass(FontColor, [{
    ...
    value: function handleChangeFontColor(value, event) {
      ...
      this.edit.toggleColor(prefix + value);
            ...
            fontColorList.map(function (list, index) {
              return _react2.default.createElement(
                ...
                list.map(function (val) {
                  return _react2.default.createElement(
                    'div',
                    { className: (0, _classnames2.default)('col-25 font-color-col', { 'active': _this2.edit.state.editorState.getCurrentInlineStyle().has(prefix + val) }), key: val },
                    _react2.default.createElement(
                      'div',
...
exports.fontColorStyleMap = fontColorStyleMap;
