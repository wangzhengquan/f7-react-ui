...
var PhotoBrowser = function PhotoBrowser(params) {
    ...
    var defaults = {
        ...
        materialPreloaderSvg: _params2.default.materialPreloaderSvg,
        materialPreloaderHtml: _params2.default.materialPreloaderHtml
        /*
        Callbacks:
    ...
    pb.open = function (index) {
        ...
        if (pb.params.type === 'popup') {
            pb.popup = _modals2.default.popup('<div class="popup photo-browser-popup">' + htmlTemplate + '</div>');
        }
        if (pb.params.type === 'page') {
            var mainView = window.mainView || _views2.default.addView('.view-main', {
    ...
    pb.onSliderTransitionStart = function (swiper) {
        ...
        (0, _dom2.default)('.photo-browser-prev, .photo-browser-next').removeClass('photo-browser-link-inactive');

        if (swiper.isBeginning && !pb.params.loop) {
            (0, _dom2.default)('.photo-browser-prev').addClass('photo-browser-link-inactive');
        }
        if (swiper.isEnd && !pb.params.loop) {
            (0, _dom2.default)('.photo-browser-next').addClass('photo-browser-link-inactive');
        }
    ...
    pb.layout = function (index) {
        if (pb.params.type === 'page') {
            pb.container = (0, _dom2.default)('.photo-browser-swiper-container').parents('.view');
        } else {
            pb.container = (0, _dom2.default)('.photo-browser');
        }
        if (pb.params.type === 'standalone') {
            pb.container.addClass('photo-browser-in');
            _navbar2.default.sizeNavbars(pb.container);
        }
        ...
        var sliderSettings = {
            ...
            onLazyImageReady: function onLazyImageReady(swiper, slide, img) {
                (0, _dom2.default)(slide).removeClass('photo-browser-slide-lazy');
        ...
        pb.swiper = _swiper2.default.swiper(pb.swiperContainer, sliderSettings);
        if (index === 0) {
    ...
    pb.attachEvents = function (detach) {
        ...
        if (pb.params.zoom) {
            ...
            // Move image
            target[action](_supportEvents2.default.touchEvents.start, pb.onSlideTouchStart);
            target[action](_supportEvents2.default.touchEvents.move, pb.onSlideTouchMove);
            target[action](_supportEvents2.default.touchEvents.end, pb.onSlideTouchEnd);
        }
    ...
    pb.onSlideGestureStart = function (e) {
        if (!gestureSlide || !gestureSlide.length) {
            gestureSlide = (0, _dom2.default)(this);
    ...
    pb.onSlideTouchMove = function (e) {
        ...
        if (!imageIsMoved) {
            imageWidth = gestureImg[0].offsetWidth;
            imageHeight = gestureImg[0].offsetHeight;
            imageStartX = _dom2.default.getTranslate(gestureImgWrap[0], 'x') || 0;
            imageStartY = _dom2.default.getTranslate(gestureImgWrap[0], 'y') || 0;
    ...
    pb.swipeCloseTouchEnd = function (swiper, e) {
        ...
        if (timeDiff < 300 && diff > 20 || timeDiff >= 300 && diff > 100) {
            setTimeout(function () {
                ...
                if (pb.params.type === 'popup') {
                    _modals2.default.closeModal(pb.popup);
                }
...
PhotoBrowser.photoBrowser = function (params) {
