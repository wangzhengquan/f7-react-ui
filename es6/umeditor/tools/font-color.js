...
var FontColor = function (_React$Component) {
  ...
  function FontColor(props) {
    ...
    _this.edit.addListener('selectionchange', function () {
      var state = _this.edit.queryCommandState('forecolor');
      _this.setState({
        value: state
      });
  ...
  _createClass(FontColor, [{
    key: 'handleExecCommand',
    value: function handleExecCommand(value, event) {
              ...
              return _react2.default.createElement(
                ...
                list.map(function (val) {
                  return _react2.default.createElement(
                    ...
                    _react2.default.createElement('a', { onClick: _this2.handleExecCommand.bind(_this2, val), className: 'btn font-color-btn', style: { backgroundColor: val, border: val === '#FFFFFF' ? '1px solid #c8c7cc' : 'none' } })
                  );
                })
              );
            })
