 ...
 */
/* eslint quotes : "off"*/
_plugins2.default.plugins['autosave'] = function () {
    ...
    //存储媒介封装
    var LocalStorage = _plugins2.default.LocalStorage = function () {
    ...
    me.commands['drafts'] = {
        execCommand: function execCommand(cmd, name) {
            if (saveKey) {
                me.body.innerHTML = LocalStorage.getLocalData(saveKey) || '<p>' + (_browser2.default.ie ? '&nbsp;' : '<br/>') + '</p>';
                me.focus(true);
            }
        },
