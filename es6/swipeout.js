...
SwipeOut.swipeoutOpenedEl = undefined;
SwipeOut.allowSwipeout = true;

SwipeOut.initSwipeout = function (swipeoutEl) {
    var isTouched,
        isMoved,
        isScrolling,
        touchesStart = {},
        ...
        noFoldLeft,
        noFoldRight;
    (0, _dom2.default)(document).on(_supportEvents2.default.touchEvents.start, function (e) {
        if (SwipeOut.swipeoutOpenedEl) {
            var target = (0, _dom2.default)(e.target);
            if (!(SwipeOut.swipeoutOpenedEl.is(target[0]) || target.parents('.swipeout').is(SwipeOut.swipeoutOpenedEl) || target.hasClass('modal-in') || target.hasClass('modal-overlay') || target.hasClass('actions-modal') || target.parents('.actions-modal.modal-in, .modal.modal-in').length > 0)) {
                SwipeOut.swipeoutClose(SwipeOut.swipeoutOpenedEl);
            }
        }
    });

    function handleTouchStart(e) {
        if (!SwipeOut.allowSwipeout) return;
        isMoved = false;
        isTouched = true;
    ...
    function handleTouchMove(e) {
        ...
        if (!isMoved) {
            if ((0, _dom2.default)('.list-block.sortable-opened').length > 0) return;
            ...
            noFoldLeft = actionsLeft.hasClass('swipeout-actions-no-fold') || _params2.default.swipeoutActionsNoFold;
            noFoldRight = actionsRight.hasClass('swipeout-actions-no-fold') || _params2.default.swipeoutActionsNoFold;
            ...
            if (!_params2.default.swipeoutNoFollow) {
        ...
        if (_params2.default.swipeoutNoFollow) {
            if (opened) {
                if (openedActions === 'right' && touchesDiff > 0) {
                    SwipeOut.swipeoutClose(swipeOutEl);
                }
                ...
                if (touchesDiff < 0 && actionsRight.length > 0) {
                    SwipeOut.swipeoutOpen(swipeOutEl, 'right');
                }
                if (touchesDiff > 0 && actionsLeft.length > 0) {
                    SwipeOut.swipeoutOpen(swipeOutEl, 'left');
                }
            }
            isTouched = false;
            isMoved = false;
        ...
        if (actionsRight.length > 0) {
            ...
            for (i = 0; i < buttonsRight.length; i++) {
                ...
                $button = (0, _dom2.default)(buttonsRight[i]);
        ...
        if (actionsLeft.length > 0) {
            ...
            for (i = 0; i < buttonsLeft.length; i++) {
                ...
                $button = (0, _dom2.default)(buttonsLeft[i]);
    ...
    function handleTouchEnd(e) {
        ...
        if (action === 'open') {
            SwipeOut.swipeoutOpenedEl = swipeOutEl;
        ...
        if (buttonsLeft && buttonsLeft.length > 0 && buttonsLeft !== buttons) {
            for (i = 0; i < buttonsLeft.length; i++) {
                ...
                (0, _dom2.default)(buttonsLeft[i]).transform('translate3d(' + buttonOffset + 'px,0,0)');
            }
        }
        if (buttonsRight && buttonsRight.length > 0 && buttonsRight !== buttons) {
            for (i = 0; i < buttonsRight.length; i++) {
                ...
                (0, _dom2.default)(buttonsRight[i]).transform('translate3d(' + -buttonOffset + 'px,0,0)');
            }
        }
    ...
    if (swipeoutEl) {
        (0, _dom2.default)(swipeoutEl).on(_supportEvents2.default.touchEvents.start, handleTouchStart);
        (0, _dom2.default)(swipeoutEl).on(_supportEvents2.default.touchEvents.move, handleTouchMove);
        (0, _dom2.default)(swipeoutEl).on(_supportEvents2.default.touchEvents.end, handleTouchEnd);
    } else {
        (0, _dom2.default)(document).on(_supportEvents2.default.touchEvents.start, '.list-block li.swipeout', handleTouchStart);
        (0, _dom2.default)(document).on(_supportEvents2.default.touchEvents.move, '.list-block li.swipeout', handleTouchMove);
        (0, _dom2.default)(document).on(_supportEvents2.default.touchEvents.end, '.list-block li.swipeout', handleTouchEnd);
    }
};
SwipeOut.swipeoutOpen = function (el, dir, callback) {
    ...
    if (el.length > 1) el = (0, _dom2.default)(el[0]);
    ...
    var noFold = swipeOutActions.hasClass('swipeout-actions-no-fold') || _params2.default.swipeoutActionsNoFold;
    ...
    if (buttons.length > 1) {
        for (i = 0; i < buttons.length; i++) {
            if (dir === 'right') {
                (0, _dom2.default)(buttons[i]).transform('translate3d(' + -buttons[i].offsetLeft + 'px,0,0)');
            } else {
                (0, _dom2.default)(buttons[i]).css('z-index', buttons.length - i).transform('translate3d(' + (swipeOutActionsWidth - buttons[i].offsetWidth - buttons[i].offsetLeft) + 'px,0,0)');
            }
        }
    ...
    for (i = 0; i < buttons.length; i++) {
        (0, _dom2.default)(buttons[i]).transform('translate3d(' + translate + 'px,0,0)');
    }
    el.find('.swipeout-content').transform('translate3d(' + translate + 'px,0,0)').transitionEnd(function () {
        el.trigger('opened');
        if (callback) callback.call(el[0]);
    });
    SwipeOut.swipeoutOpenedEl = el;
};
SwipeOut.swipeoutClose = function (el, callback) {
    el = (0, _dom2.default)(el);
    if (el.length === 0) return;
    ...
    for (var i = 0; i < buttons.length; i++) {
        if (dir === 'right') {
            ...
            (0, _dom2.default)(buttons[i]).transform('translate3d(' + (swipeOutActionsWidth - buttons[i].offsetWidth - buttons[i].offsetLeft) + 'px,0,0)');
        }
        (0, _dom2.default)(buttons[i]).css({ left: 0 + 'px' }).removeClass('swipeout-overswipe-active');
    }
    if (SwipeOut.swipeoutOpenedEl && SwipeOut.swipeoutOpenedEl[0] === el[0]) SwipeOut.swipeoutOpenedEl = undefined;
};
SwipeOut.swipeoutDelete = function (el, callback) {
    el = (0, _dom2.default)(el);
    if (el.length === 0) return;
    if (el.length > 1) el = (0, _dom2.default)(el[0]);
    SwipeOut.swipeoutOpenedEl = undefined;
