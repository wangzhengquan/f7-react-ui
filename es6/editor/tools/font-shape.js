...
var FontShape = function (_React$Component) {
  ...
  _createClass(FontShape, [{
    ...
    value: function updateCommandState() {
      ...
      fontShapList.forEach(function (val) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          fontShapList.map(function (val) {
            return _react2.default.createElement(
              'a',
              { key: val, className: (0, _classnames2.default)('btn font-shape-btn common-btn', { 'active': _this4.state.commandState[val] }), onClick: _this4.handleClickFontBtn.bind(_this4, val) },
              _react2.default.createElement('i', { className: 'icon ' + 'icon-' + val })
            );
          })
        )
      );
