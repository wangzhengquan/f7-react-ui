...
var FontSize = function (_React$Component) {
  ...
  _createClass(FontSize, [{
    ...
    value: function handleChangeFontSize(value, event) {
      var size = {};
      fontsizeList.forEach(function (val, idx) {
        size[val] = idx;
      });
      this.setState({
        value: value
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            fontsizeList.map(function (value) {
              return _react2.default.createElement(
                'div',
                { className: (0, _classnames2.default)('btn common-btn', { 'active': _this2.state.value === value }), key: value, style: { padding: '0 10px' } },
