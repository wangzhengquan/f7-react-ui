...
Editor.prototype = {
    ...
    initialCont : function(holder){
        ...
        if(holder){
            ...
            if (holder && /script|textarea/ig.test(holder.tagName)) {
                ...
                this.options.initialContent = htmlparser(holder.value || holder.innerHTML|| this.options.initialContent).toHtml();
    ...
    _setup: function (cont) {
        ...
        me.body = cont;
        me.$body = $(cont);
        me.selection = new Selection(document,me.body);
        me._isEnabled = false;
        ...
        for (var form = cont.parentNode; form && form.nodeType !==9 && !domUtils.isBody(form); form = form.parentNode) {
    ...
    getAllHtml: function () {
        ...
        return '<html><head>' + (me.options.charset ? '<meta http-equiv="Content-Type" content="text/html; charset=' + me.options.charset + '"/>' : '')
            ...
            + '<body ' + (browser.ie && browser.version < 9 ? 'class="view"' : '') + '>' + me.getContent(null, null, true) + '</body></html>';
    },
    /**
