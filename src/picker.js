...
var Picker = function (params) {
    ...
    p.initPickerCol = function (colElement, updateItems) {
        ...
        col.initEvents = function (detach) {
            ...
            col.container[method](support.touchEvents.start, handleTouchStart);
            col.container[method](support.touchEvents.move, handleTouchMove);
            col.container[method](support.touchEvents.end, handleTouchEnd);
    ...
    function onPickerClose() {
        ...
        if (p.input && p.input.length > 0) {
            ...
            if (gparams.material) p.input.trigger('blur');
        }
