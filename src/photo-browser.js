...
var PhotoBrowser = function (params) {
    ...
    var defaults = {
        ...
        materialPreloaderSvg: PARAMS.materialPreloaderSvg,
        materialPreloaderHtml: PARAMS.materialPreloaderHtml
        /*
        Callbacks:
    ...
    pb.open = function (index) {
        ...
        if (pb.params.type === 'popup') {
            pb.popup = Modals.popup('<div class="popup photo-browser-popup">' + htmlTemplate + '</div>');
        }
    ...
    pb.layout = function (index) {
        ...
        if (pb.params.type === 'standalone') {
            ...
            Navbar.sizeNavbars(pb.container);
        }
        ...
        pb.swiper = Swiper.swiper(pb.swiperContainer, sliderSettings);
        if (index === 0) {
    ...
    pb.attachEvents = function (detach) {
        ...
        if (pb.params.zoom) {
            ...
            // Move image
            target[action](Support.touchEvents.start, pb.onSlideTouchStart);
            target[action](Support.touchEvents.move, pb.onSlideTouchMove);
            target[action](Support.touchEvents.end, pb.onSlideTouchEnd);
        }
