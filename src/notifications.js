...
Notifications.addNotification = function (params) {
    ...
    if (typeof params.media === 'undefined') params.media = PARAMS.notificationMedia;
    if (typeof params.title === 'undefined') params.title = PARAMS.notificationTitle;
    if (typeof params.subtitle === 'undefined') params.subtitle = PARAMS.notificationSubtitle;
    if (typeof params.closeIcon === 'undefined') params.closeIcon = PARAMS.notificationCloseIcon;
    if (typeof params.hold === 'undefined') params.hold = PARAMS.notificationHold;
    if (typeof params.closeOnClick === 'undefined') params.closeOnClick = PARAMS.notificationCloseOnClick;
    if (typeof params.button === 'undefined') params.button = PARAMS.notificationCloseButtonText && {
        text: PARAMS.notificationCloseButtonText,
        close: true
    };
    ...
    var notificationTemplate = PARAMS.notificationTemplate ||
        '{{#if custom}}' +
        '<li>{{custom}}</li>' +
        '{{else}}' +
    ...
    if (!_compiledTemplates.notification) {
        _compiledTemplates.notification = t7.compile(notificationTemplate);
    }
